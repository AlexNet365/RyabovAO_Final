...
Процедура ВыполнитьАвтозаполнение() Экспорт
	...
	Если ЗначениеЗаполнено(НоменклатураАбонентскаяПлата) = Ложь Тогда
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = СтрШаблон("Заполните константу НоменклатураАбонентскаяПлата");
		Сообщение.Сообщить();
		Возврат;
	КонецЕсли;  
	
	Если ЗначениеЗаполнено(НоменклатураРаботыСпециалиста) = Ложь Тогда
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = СтрШаблон("Заполните константу НоменклатураРаботыСпециалиста");
		Сообщение.Сообщить();
		Возврат;
	КонецЕсли;
	...
	ОбщегоНазначения.СообщитьПользователю("Имеющаяся в абонентском договоре информация перенесена во вкладку Услуги");
